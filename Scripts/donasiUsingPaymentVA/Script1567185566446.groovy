...
Mobile.setText(findTestObject('Donasi/android.widget.EditText0 - Nominal'), '10000', 10)

Mobile.tap(findTestObject('Donasi/android.widget.TextView3 - PILIH'), 10)

Mobile.tap(findTestObject('Donasi/android.view.VABCA'), 10)
...
Mobile.verifyElementText(findTestObject('Donasi/android.widget.TextView0 - Selangkah Lagi untuk Bantu'), 'Selangkah Lagi untuk Bantu')

Mobile.tap(findTestObject('Donasi/android.widget.Button0 - OKE'), 0)

Mobile.verifyElementText(findTestObject('Donasi/android.widget.TextView2 - Rp 10.000'), 'Rp 10.000')
